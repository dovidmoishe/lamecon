...
const Hero: React.FC = () => {
    ...
    return (
        <div className="h-screen w-full relative">
            <div className="absolute inset-0 flex pt-15 flex-col justify-center items-center text-black bg-opacity-10 h-screen">
                <Text>
                    <h1 className="text-6xl font-bold text-center">Nuturing Africa future</h1>
                </Text>
                <Text className="text-lg mt-5 text-black"> Together we make the world a better place
                </Text>
